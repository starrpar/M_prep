...
public class Test {
    ...
    //I think this is not sufficient (should not allow counters sum to be negative)
    //look at NORDValidParenCheck above for better solution
...
//             initValue = inputChars.toString().substring(0, i);
//             subStr = inputChars.toString().substring(i, inputChars.length);
        
//             concatStr += parseRemainder(subStr) + ",";
//             System.out.println(concatStr);

//             strWithOps = applyOperators(concatStr);
//             return concatStr;
//         }
